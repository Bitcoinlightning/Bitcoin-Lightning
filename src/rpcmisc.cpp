...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <Bitcoin_Lightningaddress>\n"
            "Return information about <Bitcoin_Lightningaddress>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <Bitcoin_Lightningpubkey>\n"
            "Return information about <Bitcoin_Lightningpubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <Bitcoin_Lightningaddress> <signature> <message>\n"
